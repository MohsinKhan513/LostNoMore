...
const UserSchema = new mongoose.Schema({
  ...
  // ======================================================
  // NEW: WhatsApp number (optional, international E.164 format)
  // ======================================================
  whatsapp: {
    type: String,
    default: null,
  ...
  // ======================================================
  // Public HTTPS URL of profile image when using Cloudinary
  profilePicture: {
    type: String,
    default: null,
  },
  // Cloudinary public id for the stored asset (used for deletion)
